...
require('dotenv').config();  // another way to load environment variables

// CONSTANTS
const USER_NAME = process.env.USER_NAME;
const PASSWORD = process.env.PASSWORD; 
const DB_NAME =  process.env.DB_NAME; // TODO: Change this to your database name
// console.log(USER_NAME, PASSWORD, DB_NAME);
const DB_URI = `mongodb+srv://${USER_NAME}:${PASSWORD}@merncluster.yuwtlwd.mongodb.net/${DB_NAME}?retryWrites=true&w=majority&appName=mernCluster`;
